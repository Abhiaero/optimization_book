...
# Define the Schwefel 2.21 Function
def schwefel_2_21_function(x1, x2):
...
Z = schwefel_2_21_function(X1, X2)

# Optimal solution
optimal_x1, optimal_x2 = 0, 0
optimal_z = schwefel_2_21_function(optimal_x1, optimal_x2)
...
ax1.zaxis.set_major_formatter(plt.FuncFormatter(lambda x, _: f'{x:.0f}'))
