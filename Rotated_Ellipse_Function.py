...
# Define the Rotated Ellipse Function
def rotated_ellipse_function(x1, x2):
    term1 = x1**2 / 1
    term2 = x2**2 / 2
    return term1 + term2
...
Z = rotated_ellipse_function(X1, X2)

# Optimal solution
optimal_x1, optimal_x2 = 0, 0
optimal_z = rotated_ellipse_function(optimal_x1, optimal_x2)
