...
# Define the Schumer Steiglitz Function
def schumer_steiglitz_function(x1, x2):
    return x1**4 + x2**4
...
Z = schumer_steiglitz_function(X1, X2)

# Optimal solution
optimal_x1, optimal_x2 = 0, 0
optimal_z = schumer_steiglitz_function(optimal_x1, optimal_x2)
