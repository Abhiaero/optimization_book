...
# Define the Chung Reynolds Function
def chung_reynolds_function(x1, x2):
    return (x1**2 + x2**2)**2

# Generate grid
x1_vals = np.linspace(-100, 100, 200)
x2_vals = np.linspace(-100, 100, 200)
X1, X2 = np.meshgrid(x1_vals, x2_vals)
Z = chung_reynolds_function(X1, X2)

# Optimal solution
optimal_x1, optimal_x2 = 0, 0
optimal_z = chung_reynolds_function(optimal_x1, optimal_x2)
...
ax1.set_xticks(np.arange(-100, 101, 50))
