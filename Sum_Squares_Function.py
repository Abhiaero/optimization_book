...
def sum_of_squares_function(x1, x2):
    return 1 * x1**2 + 2 * x2**2  # Weights applied to squared terms

# Generate grid
x1_vals = np.linspace(-10, 10, 200)
x2_vals = np.linspace(-10, 10, 200)
X1, X2 = np.meshgrid(x1_vals, x2_vals)
Z = sum_of_squares_function(X1, X2)

# Optimal solution
optimal_x1, optimal_x2 = 0, 0
optimal_z = sum_of_squares_function(optimal_x1, optimal_x2)
